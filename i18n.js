...
const translations = {
    ...
    'en': {
        ...
        // Accounting Page
        'acc-title': '💰 Accounting System',
        'acc-header': '💰 Accounting System',
        'acc-tab-month': '📅 Monthly',
        'acc-tab-add': '📝 Add Record',
        'acc-tab-year': '📊 Yearly Stats',
        'acc-tab-tpl': '🎯 Template',
        'acc-balance': 'Balance',
        'acc-income': 'Income',
        'acc-expense': 'Expense',
        'acc-edit-title': 'Edit Record',
        'acc-save': 'Save Changes',
        'acc-delete': 'Delete',
        'acc-cancel': 'Cancel',
        'acc-btn-tpl-gen': '🚀 One-Click Generate',
        'acc-add-title': 'New Entry',
        'acc-category': 'Category:',
        'cat-temp': 'Temporary',
        'cat-delivery': 'Delivery',
        'cat-daily': 'Daily Wage',
        'cat-food': 'Food',
        'cat-trans': 'Transport',
        'acc-btn-add': '✓ Confirm',
        'acc-no-records': 'No records this month',
    ...
    'ja': {
        ...
        'acc-income': '収入',
        'acc-expense': '支出',
        'acc-edit-title': '記録の編集',
        'acc-save': '変更を保存',
        'acc-delete': '削除',
        'acc-cancel': 'キャンセル',
        'acc-btn-tpl-gen': '🚀 今月分を一括生成',
        'acc-add-title': '新規登録',
        'acc-category': 'カテゴリー：',
        'cat-temp': '臨時追加',
        'cat-delivery': '配達報酬',
    ...
    'ko': {
        ...
        'acc-income': '수입',
        'acc-expense': '지출',
        'acc-edit-title': '내역 수정',
        'acc-save': '저장하기',
        'acc-delete': '삭제하기',
        'acc-cancel': '취소',
        'acc-btn-tpl-gen': '🚀 이번 달 내역 자동 생성',
        'acc-add-title': '새 기록',
        'acc-category': '분류:',
        'cat-temp': '임시 추가',
        'cat-delivery': '배달 수입',
